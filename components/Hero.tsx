  ...
  return (
    ...
    <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <TextGenerateEffect className='text-center text-[40px] md:text-5xl lg:6xl ' words='Turning ideas into engaging and user-friendly web applications'/>
            <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                Hi, I&apos;m Areeba Zafar, a Frontend Developer based in Karachi, Pakistan.
            </p>
            <a href="#about">
                <MagicButton 
                title="Show my work"
